...
<?php
    ...
    //sleep(1); // Here call your time taking function like sending bulk sms etc.
		...
		if(!empty($_POST['check_list'])){
			$myfile = fopen("../projects/MavenReport/input.txt", "w") or die("Unable to open file!");
		// Loop to store and display values of individual checked checkbox.
		foreach($_POST['check_list'] as $selected){
			$myfile = fopen("../projects/MavenReport/input.txt", "a",FILE_IGNORE_NEW_LINES) or die("Unable to open file!");
